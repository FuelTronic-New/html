...
angular.module("objectTable", []).directive("contenteditable", function () {
    return {
        restrict: "A", require: ["ngModel", "^objectTable"], link: function (e, t, r, n) {
            var a = n[0], o = n[1];
            a.$render = function () {
                t.html(a.$viewValue || "")
            }, t.bind("change blur", function () {
                var r = a.$viewValue.toString(), n = t.text();
                r !== n && (e.$apply(function () {
                    a.$setViewValue(n)
                }), o.onEdit && "function" == typeof o.onEdit && o.onEdit({$oldValue: r, $newValue: n}))
            })
        }
    }
    ...
    return {
        ...
        compile: function (e, t) {
            ...
            }) : ("undefined" == typeof t.search || "true" === t.search) && (r += "| filter:globalSearch"), n += " | offset: currentPage:display |limitTo: display", e[0].querySelector("#rowTr").setAttribute("ng-repeat", "item in $parent.$filtered = (data" + r + ")" + n), e.find("paging").attr("count", "$filtered.length"), function (e, t, a, o, i) {
                o._init(), i(e, function (t, a) {
                    e.$owner = a.$parent;
                    for (var i in t)if (t.hasOwnProperty(i))switch (t[i].tagName) {
                        case"THEAD":
                            o._addHeaderPattern(t[i]);
                            break;
                        case"TBODY":
                            e.findBody = !0, o._addRowPattern(t[i], r, n);
                            console.log(e.findBody);
                            break;
                        case"TFOOT":
        ...
        restrict: "A", controller: function () {
            ...
            return function (e, t, n, a) {
                t.attr("draggable", !0), t.bind("dragstart", function (e) {
                    ...
                    t.dataTransfer.setData("text", a.target.cellIndex)
                    ...
                    var n = a.toTarget.cellIndex, o = e.originalEvent || e, i = parseInt(o.dataTransfer.getData("text"), 10);
                    r(t, "dragged"), r(t, "draggedOver"), t.parent().controller("objectTable").changeColumnsOrder(n, i), e.preventDefault()
                })
            }
        }
    }
}), angular.module("objectTable").controller("objectTableCtrl", ["$scope", "$timeout", "$element", "$attrs", "$http", "$compile", "$controller", "objectTableUtilService",'$modal', function (e, t, r, n, a, o, i, l,m) {
    i("objectTableSortingCtrl", {$scope: e});
    var s = this;
    this._init = function () {
        e.headers = [], e.fields = [], e.display = e.display || 5, e.paging = angular.isDefined(e.paging) ? e.paging : !0, e.sortingType = e.sortingType || "simple", e.currentPage = 0, e.customHeader = !1, "separate" == n.search ? (e.search = "separate", e.columnSearch = []) : e.search = "undefined" == typeof n.search || "true" === n.search, e.headers = l.getArrayFromParams(n.headers, "headers"), e.fields = l.getArrayFromParams(n.fields, "fields"), n.fromUrl && this._loadExternalData(n.fromUrl), e.onEdit && (this.onEdit = e.onEdit), e.selectedModel = "multiply" === e.select ? [] : {}
    }, this.onEdit = e.onEdit, this._loadExternalData = function (t) {
        ...
        e.$apply(function () {
            if (e.fields.swap(t, n), e.headers.swap(t, n), e.columnSearch && e.columnSearch.swap(t, n), s.bodyTemplate) {
                var a = angular.element(s.bodyTemplate).children(), i = document.createElement("tr"), l = document.createElement("tbody"), d = r.find("tbody").find("tr")[0].attributes;
                Array.prototype.swap.apply(a, [t, n]), [].forEach.call(d, function (e, t) {
                    i.setAttribute(e.name, e.value)
                });
                for (var c = 0, u = a.length; u > c; c++)i.appendChild(a[c]);
                l.appendChild(i), r.find("tbody").replaceWith(l), s.bodyTemplate = l.innerHTML, o(r.find("tbody"))(e)
            }
            if (e.customHeader) {
                var g = r.find("th"), i = document.createElement("tr"), p = document.createElement("thead");
                Array.prototype.swap.apply(g, [t, n]);
                for (var c = 0, u = g.length; u > c; c++)i.appendChild(g[c]);
    ...
    e.currentPage = 0, e.prevPage = function () {
        ...
        var t = e.pageCount() + 1 < 5 ? e.pageCount() + 1 : 5, r = [], n = e.currentPage;
    ...
    e.sort = {fields: [], reverse: []}, e.sortingArray = [], e.sortBy = function (t) {
    ...
    return Array.prototype.swap = function (e, t) {
        if (e >= this.length)for (var r = e - this.length; r-- + 1;)this.push(void 0);
